 ...
 */
final class Version20220407100413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee DROP designation');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee ADD designation VARCHAR(255) DEFAULT NULL');
    }
}
